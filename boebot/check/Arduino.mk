...
# General arguments
PROJECT_LIBS = $(patsubst %,$(USER_LIB_DIR)/%,$(USER_LIBS))
...
PROJECT_LIB_OBJS      = $(patsubst $(USER_LIB_DIR)/%.c,$(OBJDIR)/libs/%.o,$(PROJECT_LIB_C_SRCS)) \
	$(patsubst $(USER_LIB_DIR)/%.cpp,$(OBJDIR)/libs/%.o,$(PROJECT_LIB_CPP_SRCS))
...
CPPFLAGS      = -mmcu=$(MCU) -DF_CPU=$(F_CPU) -DARDUINO=$(ARDUINO_VERSION) \
	...
	$(PROJECT_INCLUDES) $(SYS_INCLUDES) -g -Os -w -Wall \
...
# library sources
$(OBJDIR)/libs/%.o: $(USER_LIB_DIR)/%.c
	mkdir -p $(dir $@)
	$(CC) -c $(CPPFLAGS) $(CFLAGS) $< -o $@

$(OBJDIR)/libs/%.o: $(USER_LIB_DIR)/%.cpp
	mkdir -p $(dir $@)
...
$(TARGET_ELF): 	$(LOCAL_OBJS) $(CORE_LIB) $(OTHER_OBJS) $(PROJECT_LIB_OBJS)
		$(CC) $(LDFLAGS) -o $@ $(LOCAL_OBJS) $(CORE_LIB) $(OTHER_OBJS) -lc -lm

$(CORE_LIB):	$(CORE_OBJS) $(LIB_OBJS) $(PROJECT_LIB_OBJS)
		$(AR) rcs $@ $(CORE_OBJS) $(LIB_OBJS) $(PROJECT_LIB_OBJS)
...
clean:
		$(REMOVE) $(LOCAL_OBJS) $(CORE_OBJS) $(LIB_OBJS) $(PROJECT_LIB_OBJS) $(CORE_LIB) $(TARGETS) $(DEP_FILE) $(DEPS)
